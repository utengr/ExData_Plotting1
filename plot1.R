...
# generate histogram of Global Active Power, color it red, and label the appropriate axis and title
hist(data[,3], xlab = "Global Active Power (kilowatts)",main = "Global Active Power", col = "red")

# confirm the plot and then opena png file and re-plot the histogram to the file.
